...
public class SymbolTable {
    ...
    private final Map<String, SymbolTableEntry> table = new HashMap<>();//这里的String就是SymbolTableEntry里的text元素，用来在表里快速定位Entry
    ...
    public SymbolTableEntry add(String text) {
        if(table.containsKey(text)){
            throw new RuntimeException("Record already exits:" + text);
        }
    ...
    public void setIntType(String text) {
        table.get(text).setType(Int);
    }
